...
RSpec.describe CohortsController, :type => :controller do
  describe 'GET #index' do
    ...
    xit 'INDEX creates an @student obj combining user, student, and cohort tables' do
    end

    xit 'INDEX creates an @deliverables obj combining deliverable and cohort tables' do
    end
  end
